...
lhlianjiaT = lianjiaDB['lhlianjiaT']

class lhlianjiaSpider(scrapy.Spider):
    name = 'lhlianjia'
    ...
    def __init__(self, query='', **kwargs):
        ...
        self.query = query
        self.base_url = "https://sz.lianjia.com/ershoufang/luohuqu/sf1bp0ep800"
    ...
    def parse(self, response):
        ...
        for house in houseList:
            ...
            result = lhlianjiaT.insert_one(item)
            yield item
...
if __name__ == '__main__':
    ...
    args = "scrapy crawl lhlianjia".split()
    cmdline.execute(args)

#运行spider命令
#scrapy runspider lhlianjia.py -a query=ershoufang/ie2y4l2l3a3a4p5
