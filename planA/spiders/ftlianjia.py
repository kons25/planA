...
ftlianjiaT = lianjiaDB['ftlianjiaT']

class ftlianjiaSpider(scrapy.Spider):
    name = 'ftlianjia'
    ...
    def __init__(self, query='', **kwargs):
        ...
        self.query = query
        self.base_url = "https://sz.lianjia.com/ershoufang/futianqu/sf1bp0ep800"
    ...
    def parse(self, response):
        ...
        for house in houseList:
            ...
            result = ftlianjiaT.insert_one(item)
            yield item
...
if __name__ == '__main__':
    ...
    args = "scrapy crawl ftlianjia".split()
    cmdline.execute(args)

#运行spider命令
#scrapy runspider ftlianjia.py -a query=ershoufang/ie2y4l2l3a3a4p5
