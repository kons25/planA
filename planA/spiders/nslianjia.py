...
nslianjiaT = lianjiaDB['nslianjiaT']

class NslianjiaSpider(scrapy.Spider):
    name = 'nslianjia'
    ...
    def parse(self, response):
        ...
        for house in houseList:
            ...
            result = nslianjiaT.insert_one(item)
            yield item
...
if __name__ == '__main__':
    ...
    args = "scrapy crawl nslianjia".split()
    cmdline.execute(args)

#运行spider命令
#scrapy runspider nslianjia.py -a query=ershoufang/ie2y4l2l3a3a4p5
